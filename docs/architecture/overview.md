...
- 🖥️ `apps/web` — Next.js App Router UI and Vercel-ready demo handlers
- ⚙️ `apps/api` — NestJS demo API with controller/service boundaries and shared schema validation
